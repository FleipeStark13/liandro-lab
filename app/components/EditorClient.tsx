...
import SlugCreator from "@/services/slug_creator";
...
const Tiptap = () => {
  ...
  useEffect(() => {
    const newSlug = SlugCreator(title);
    if (newSlug) {
      setSlug(newSlug);
    }
  }, [title])
    ...
    <>
      <div className="flex flex-col">
        <div className="w-full p-2">
          ...
          <br />
          <input value={title} onChange={(e) => setTitle(e.target.value)} type="text" placeholder="Insira o titulo da postagem" />

          <br />

          <label>Sumario</label>
          <br />
          <input value={summary} onChange={(e) => setSumary(e.target.value)} type="text" placeholder="Insira o titulo da postagem" />
